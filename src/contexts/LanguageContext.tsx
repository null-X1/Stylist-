...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    unlock_stylist: 'Unlock your stylist and start building your future wardrobe today.',
  ...
  ar: {
    ...
    ai_entry: 'التحليل التلقائي للصورة',
